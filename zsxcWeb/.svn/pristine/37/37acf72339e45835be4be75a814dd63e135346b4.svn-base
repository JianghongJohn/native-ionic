...
@interface CarOrderCarInfoController ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)UITableView *tableView;
@end
@implementation CarOrderCarInfoController
...
- (void)viewDidLoad {
    ...
    if (!self.viewModel) {
        ...
        self.viewModel = [[CarOrderCarInfoViewModel alloc] init];
    }
...
-(void)_creatSubmitButton{
    ...
    [button setTitle:@"保存车辆信息" forState:0];
 ...
 */
-(void)_submit{
    [[NSNotificationCenter defaultCenter]postNotificationName:kSubmitCarOrder object:self.viewModel.car];
