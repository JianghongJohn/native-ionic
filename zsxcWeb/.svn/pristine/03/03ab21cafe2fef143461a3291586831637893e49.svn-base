...
-(UITableViewCell *)JH_setUpTableViewCell:(NSIndexPath *)indexPath WithHandle:(void(^)())completionBlock{
    ...
    [cell setCalculateBlock:^(){
       float totalPrice = [self.advance.keepprice floatValue]+[self.advance.canalsprice floatValue]+[self.advance.mortgageprice floatValue]+[self.advance.gopledge floatValue]+[self.advance.mortgagehigh floatValue]+[self.advance.mortgagecash floatValue];
