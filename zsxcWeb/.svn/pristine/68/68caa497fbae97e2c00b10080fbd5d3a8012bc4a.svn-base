...
@implementation ServiceTextCell
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    _refreshBlock(_key,nil);
    }else{
    _refreshBlock(_key,textField.text);
    }
}
//使小数点只有一个
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    return [self isValidAboutInputText:textField shouldChangeCharactersInRange:range replacementString:string decimalNumber:100];
}
/**
